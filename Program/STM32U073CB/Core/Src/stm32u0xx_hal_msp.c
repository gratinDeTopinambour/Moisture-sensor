...
void HAL_TSC_MspInit(TSC_HandleTypeDef* htsc)
{
  ...
  if(htsc->Instance==TSC)
  {
    ...
    PB13     ------> TSC_G1_IO2
    */
    GPIO_InitStruct.Pin = Probe_Capa_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF9_TSC;
    HAL_GPIO_Init(Probe_Capa_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = Sampling_Capa_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF9_TSC;
    HAL_GPIO_Init(Sampling_Capa_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TSC_MspDeInit(TSC_HandleTypeDef* htsc)
{
  if(htsc->Instance==TSC)
  {
    ...
    PB13     ------> TSC_G1_IO2
    */
    HAL_GPIO_DeInit(GPIOB, Probe_Capa_Pin|Sampling_Capa_Pin);
